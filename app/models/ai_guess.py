...
def generate_description_from_pil(image, guessed_words=[], model_name="gemini-1.5-flash"):
    ...
    prompt_list.extend([
        ...
        "Ten en cuenta que las posibles respuestas son: casa, flor, árbol, sol, luna, perro, gato, auto, barco, montaña, río, mar, nube, estrella, lluvia, nieve, viento, hoja, fruta, pan, agua, fuego, tierra, aire, cielo, camino, puente, calle, ciudad, campo, libro, mesa, silla, cama, puerta, ventana, reloj, lápiz, papel, color, rojo, azul, verde, amarillo, blanco, negro, círculo, cuadrado, triángulo, corazón, cara, mano, pie, ojo, nariz, boca, pelo, cabeza, brazo, pierna, niño, niña, hombre, mujer, bebé, familia, amigo, escuela, trabajo, juego, pelota, muñeca, coche, avión, tren, bicicleta, moto, sombrero, zapato, ropa, comida, bebida, dulce, pastel, helado, queso, leche, huevo, carne, pez, pollo, vaca, cerdo, pájaro, ratón, conejo, elefante, león, tigre, oso, mono, delfín, ballena, tortuga, serpiente, araña, hormiga, abeja, mariposa.",
